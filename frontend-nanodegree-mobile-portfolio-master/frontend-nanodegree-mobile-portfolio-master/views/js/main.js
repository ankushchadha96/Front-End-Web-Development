...
document.addEventListener('DOMContentLoaded', function () {
    var cols = 8;
    var s = 256;
    var pizaNumber = function () {
        var a = Math.max(document.documentElement.clientHeight, window.innerHeight);
        return Math.round(a / 4 / 8);
    }

    var pizaCount = pizaNumber();

    for (var i = 0; i < pizaCount; i++) {
        ...
        document.getElementById("movingPizzas1").appendChild(element);
    }
    updatePositions();
});